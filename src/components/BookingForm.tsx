...
export default function BookingForm({ lang }: BookingFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <button
        type="submit"
        className="mt-2 flex items-center justify-center gap-2.5 w-full py-3.5 bg-[#25D366] text-[#0e3b2e] border-none rounded-xl text-sm font-bold tracking-[0.5rem] cursor-pointer transition-all duration-200 shadow-[0_4px_15px_rgba(37,211,102,0.35)] hover:bg-[#1ebe5d] hover:shadow-[0_6px_20px_rgba(37,211,102,0.45)] active:scale-95 font-inherit"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="#0e3b2e">
